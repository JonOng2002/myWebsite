<template>
    <div class="col-span-2 row-span-1 rounded-[2rem] hover:ring-2 p-6 py-2">
      <form @submit.prevent="handleSubmit" class="flex flex-col gap-4 mt-4 w-full h-full">
        <input v-model="formData.name" type="text" placeholder="Your Name" required class="p-2 rounded-lg border text-gray-800 border-gray-300">
        <input v-model="formData.email" type="email" placeholder="Your Email" required class="p-2 rounded-lg border text-gray-800 border-gray-300">
        <textarea v-model="formData.message" placeholder="Your Message" required class="p-2 rounded-lg border text-gray-800 border-gray-300"></textarea>
